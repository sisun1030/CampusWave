...
<body onload="init(); centerPopup(); loadPopup(); ">
	...
	<div class="box">
		...
		<div class="boxBody">
			...
			<div id="signin" class="show">
				...
				<a href='' style='float:right; padding-right:30px; padding-top:5px;'>Forgot your password?</a>
			</div>  
			...
			<div id="signup">
				 <table>
					<tr>
						...
						<td><input type='text' name='name' id='name' style="width:200px"  maxlength="50" /></td>
					</tr>
					<tr>
						<td><label for='email' style="font-size:12px" >Email:</label></td>
						<td><input type='text' name='email' id='email' style="width:200px"  maxlength="50" /></td>
					...
					<tr>
						...
						<td><input type='password' name='password2' id='password2' maxlength="100" style="width:200px" /></td>
					</tr>
					<tr>
						<td/>
						<td><input type='submit' name='Submit' value='Submit' style="background-color:#F8D300; float:right;" /></td>
					</tr>
				</table>
			</div>
