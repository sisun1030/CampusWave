...
<div class='box'>
   ...
   <div id="scheduler_here" class="dhx_cal_container" style='width:700px; height:300px; position:absolute; top:50px; left:20px;padding-bottom:30px;text-transform:none'>
